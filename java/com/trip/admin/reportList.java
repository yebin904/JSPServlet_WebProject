...
public class reportList extends HttpServlet {
    /**
     * '대기 중'인 신고 목록을 조회하여 JSP 페이지로 전달합니다.
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        List<reportDTO> list = dao.getPendingReports();
        req.setAttribute("list", list);

        RequestDispatcher dispatcher = req.getRequestDispatcher("/WEB-INF/views/admin/reportlist.jsp");
