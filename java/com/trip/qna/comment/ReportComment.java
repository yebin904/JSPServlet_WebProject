...
/**
 * Q&A 게시물 댓글 신고를 처리하는 서블릿
 * @author jsg
 * @version 1.0
 * @since 2025.10.24
 */
@WebServlet("/qna/reportComment.do")
public class ReportComment extends HttpServlet {
    /**
     * GET 요청을 처리하여 Q&A 게시물 댓글을 신고합니다.
     * 세션에서 사용자 ID를 확인하고, 댓글 ID를 받아 신고 처리합니다.
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        boolean success = dao.reportComment(commentId);
        dao.close();
